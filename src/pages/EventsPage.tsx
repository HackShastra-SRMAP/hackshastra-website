    ...
    <div className="bg-background text-foreground min-h-screen">
      <section className="pt-24 md:pt-32 pb-12 md:pb-16 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-tight mb-4 md:mb-6">
            All <span className="text-red-600 fire-text">Events & Hackathons</span>
          </h1>
      ...
      <section className="py-12 md:py-20 px-4 sm:px-6 bg-card border-y border-border">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            href="/contact"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-neutral-900 border border-neutral-700 hover:border-red-600 text-white font-semibold text-sm transition-all"
          >
            Partner With Us
          </a>
        </div>
